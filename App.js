...
import SchedulingAlgorithmsScreen from "./src/Screens/SchedulingAlgorithmsScreen";
import { Provider as AlgoProvider } from "./src/context/algoContext";
import FCFSAlgoScreen from "./src/Screens/FCFSAlgoScreen";
...
const SchedulingAlgosFlow = () => {
  return (
    <Stack.Navigator>
      <Stack.Screen
        name="Scheduling Algorithms Screen"
        component={SchedulingAlgorithmsScreen}
        options={{
          headerShown: false,
        }}
      />
      <Stack.Screen
        name="FCFS Algorithms Screen"
        component={FCFSAlgoScreen}
        options={{
          headerShown: false,
        }}
      />
